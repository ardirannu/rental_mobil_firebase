...
<div class="container" style="margin-top: 79px;">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-primary text-light">{{ __('Pelanggan Login') }}</div>
                    ...
                    <form method="POST" action="{{ route('pelanggan.login.submit') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                ...
                                @if (Route::has('pelanggan.password.request'))
                                    <a class="btn btn-link" href="{{ route('pelanggan.password.request')}}">
